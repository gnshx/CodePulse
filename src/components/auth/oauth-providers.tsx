      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {googleEnabled && (
          <form action={signInWithGoogle} style={{ width: "100%" }}>
            <button type="submit" className="auth-provider-button" id="login-google-btn">
        ...
        {githubEnabled && (
          <form action={signInWithGitHub} style={{ width: "100%" }}>
            <button type="submit" className="auth-provider-button" id="login-github-btn">
